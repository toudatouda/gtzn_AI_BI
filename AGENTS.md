...
When in plan mode, always write plan files to the project directory `.Codex/plans/` instead of the default `~/.Codex/plans/`. Use descriptive filenames based on the task topic (e.g., `common-agent-refactor-skill-mcp.md`).
